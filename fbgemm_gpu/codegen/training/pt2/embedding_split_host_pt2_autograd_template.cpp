...
{%- endmacro %}
{%- macro get_optional_optim_tensor(name, suffix, idx) %}
...
{%- macro unpack_tensorlist_optional(name, arg_index) %}
  ...
  {{ get_optional_optim_tensor(name, "host", arg_index * 5) }}
  {{ get_optional_optim_tensor(name, "dev", arg_index * 5 + 1) }}
  {{ get_optional_optim_tensor(name, "uvm", arg_index * 5 + 2) }}
  {{ get_optional_optim_tensor(name, "placements", arg_index * 5 + 3) }}
  {{ get_optional_optim_tensor(name, "offsets", arg_index * 5 + 4) }}
{%- endmacro %}
